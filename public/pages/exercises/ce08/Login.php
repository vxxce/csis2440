...
if (isset($_POST['email'], $_POST['pass']) && $_POST['email'] != "" && $_POST['pass'] != "") require "authenticate.php";
?>
...
<?php unset($_SESSION['loginError'], $_SESSION['newUser']);
